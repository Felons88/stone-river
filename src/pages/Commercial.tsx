...
const Commercial = () => {
  const items = [
    ...
    "Pallets & Shipping Materials",
    "Retail Fixtures & Displays",
    "Restaurant Equipment",
    "Warehouse Cleanouts",
    "Office Renovations Debris",
    "Old Inventory & Stock",
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-primary/10 border-2 border-primary/20 rounded-full mb-6">
              ...
              <span className="font-bold text-gray-900">Commercial Services</span>
            </div>
            ...
            <p className="text-xl sm:text-2xl text-gray-700 mb-8 leading-relaxed font-medium">
              Professional junk removal for businesses of all sizes. Minimize downtime with our efficient service.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-700 text-center mb-12 font-medium">
              Professional removal for offices, retail, restaurants, and warehouses!
            </p>
            ...
            {[
              {
                ...
                description: "We work around your business hours. Evening and weekend appointments available."
              },
              {
                title: "Fast & Efficient",
                description: "Minimize downtime with our professional team. We get in, get it done, and get out."
              },
              {
                title: "Eco-Friendly",
                description: "We donate and recycle whenever possible. Responsible disposal is our priority."
              }
            ].map((benefit, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-gradient-to-br from-primary via-orange-600 to-red-600">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl sm:text-5xl font-black text-white mb-6 uppercase">
            READY TO STREAMLINE YOUR SPACE?
          </h2>
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Get your free commercial quote today! Flexible scheduling available.
          </p>
          <Button
            size="lg"
